// =========================================
// WOKWI DEVICE 3 (ZONE 3 - UI, Depok)
// =========================================
#include <WiFi.h>
#include <DHT.h>
...
#define ZONE_ID    3   // Stasiun 3 (UI, Depok)
#define DHT_PIN    4
...
void setup() {
    ...
    Serial.println("====================================");
    Serial.println("  Device 3: Stasiun Udara Kampus");
    Serial.println("  Zone 3 - UI, Depok");
    Serial.println("====================================");
...
void loop() {
    ...
    if (!mqtt.connected()) {
        mqtt.connect("ESP32-AirStation-Zone3"); // MQTT Client ID harus unik
    }
    mqtt.loop();
